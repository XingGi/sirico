...
import KRICard from "./components/KRICard"; // <-- PERUBAHAN: path diperbarui
import HorizonScanWidget from "./components/HorizonScanWidget"; // <-- PERUBAHAN: path diperbarui
import AssessmentListWidget from "./components/AssessmentListWidget"; // <-- PERUBAHAN: path diperbarui
import QuickActionsWidget from "./components/QuickActionsWidget"; // <-- PERUBAHAN: path diperbarui
import RiskMatrixWidget from "./components/RiskMatrixWidget"; // <-- PERUBAHAN: path diperbarui
